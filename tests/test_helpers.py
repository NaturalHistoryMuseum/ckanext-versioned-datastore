...
from ckanext.versioned_datastore.helpers import is_duplicate_ingestion, get_human_duration, \
    get_stat_icon, get_stat_activity_class, get_stat_title, get_available_formats
from ckanext.versioned_datastore.lib.common import ALL_FORMATS
from ckanext.versioned_datastore.lib.importing.ingestion.exceptions import DuplicateDataSource, \
    UnsupportedDataSource
from ckanext.versioned_datastore.lib.importing.stats import INGEST, INDEX, PREP, ALL_TYPES
...
class TestHelpers(object):
    ...
    def test_get_stat_activity_class(self):
        ...
        for stat_type in ALL_TYPES + [MagicMock()]:
            assert get_stat_activity_class(
                MagicMock(in_progress=False, error=None, type=stat_type)) == stat_type
