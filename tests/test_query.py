...
class TestQuery(object):
    ...
    def test_load_core_schema(self):
        ...
        assert hasattr(validator, u'validate')
    ...
    def test_get_latest_query_version(self):
        ...
        with patch(u'ckanext.versioned_datastore.lib.query.schema.schemas', test_schemas):
            assert schema_lib.get_latest_query_version() == u'v1.0.0'
    ...
    def test_validate_query_valid(self):
        ...
        with patch(u'ckanext.versioned_datastore.lib.query.schema.schemas', test_schemas):
            assert schema_lib.validate_query(MagicMock(), u'v1.0.0')
    ...
    def test_register_schema(self):
        ...
        assert list(schema_lib.schemas.keys()) == [u'v1.0.1']
        schema_lib.register_schema(u'v1.0.0', MagicMock())
        assert list(schema_lib.schemas.keys()) == [u'v1.0.0', u'v1.0.1']
        schema_lib.register_schema(u'v2.0.1', MagicMock())
        assert list(schema_lib.schemas.keys()) == [u'v1.0.0', u'v1.0.1', u'v2.0.1']
