...
from ckanext.versioned_datastore.lib.downloads.derivatives.base import (
    BaseDerivativeGenerator,
)
from ckanext.versioned_datastore.lib.downloads.derivatives.dwc import urls, utils
...
class DwcDerivativeGenerator(BaseDerivativeGenerator):
    ...
    def make_eml(self):
        ...
        resources = [resource_show({}, {'id': r}) for r in self._query.resource_ids]
