...
from ckanext.versioned_datastore.lib.downloads.derivatives.dwc.schema_parts import (
    Domain,
    Extension,
    Prop,
    PropCollection,
)
from ckanext.versioned_datastore.lib.downloads.derivatives.dwc.urls import TDWGUrls
from ckanext.versioned_datastore.lib.downloads.derivatives.dwc.utils import load_schema
