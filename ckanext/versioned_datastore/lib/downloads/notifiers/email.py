...
class EmailNotifier(BaseNotifier):
    ...
    def notify_start(self):
        ...
        for address in self.email_addresses:
            mailer.mail_recipient(recipient_email=address, recipient_name='Downloader',
                                  subject='Data download started', body=body, body_html=body_html)
    ...
    def notify_end(self, file_url):
        ...
        for address in self.email_addresses:
            mailer.mail_recipient(recipient_email=address, recipient_name='Downloader',
                                  subject='Data download complete', body=body, body_html=body_html)
    ...
    def notify_error(self):
        ...
        for address in self.email_addresses:
            mailer.mail_recipient(recipient_email=address, recipient_name='Downloader',
                                  subject='Data download failed', body=body, body_html=body_html)
